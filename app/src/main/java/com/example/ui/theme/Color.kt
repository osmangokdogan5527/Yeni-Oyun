...
val MdBackground = Color(0xFFF3F0F5)
val MdOnBackground = Color(0xFF1C1B1F)

val MdSurface = Color(0xFFFEF7FF)
val MdOnSurface = Color(0xFF1C1B1F)
val MdSurfaceVariant = Color(0xFFE7E0EC)
val MdOnSurfaceVariant = Color(0xFF49454F)

val MdOutline = Color(0xFFCAC4D0)

val MdError = Color(0xFFB3261E)
val MdOnError = Color(0xFFFFFFFF)
val MdErrorContainer = Color(0xFFFFD8E4)
